...
export default function Home() {
  ...
  async function beginZkLogin(provider: OpenIdProvider) {
      ...
      const loginUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${process.env.CLIENT_ID}&response_type=id_token&redirect_uri=${REDIRECT_URL}&scope=openid&nonce=${nonce}`
